...
public class GamePanel extends JPanel implements Runnable {
	...
	// SCREEN SETTINGS
	final int originalTileSize = 16; // 16x16 tile of player character, tile size, npc etc....
	final int scale = 3;
...
//	}
	...
	public void paintComponent(Graphics g) {
		...
		if (keyH.showDebugText == true) {
			...
			g2.drawString("God mode: " + keyH.godModeOn, x, y); // God mode DEBUG
		}
