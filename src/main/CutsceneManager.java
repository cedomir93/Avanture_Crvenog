...
public class CutsceneManager {
	...
	public void scene_ending() {
		...
		if (scenePhase == 10) {
			drawBlackBackground(1.0F);
			gp.getClass();
			drawString(1.0F, 38.0F, 576 / 2 - 0, "Да ову годину, проведите са људима које волите, \nкојима сте окружени, \nкоји вас чине срећним, \nкоји су уз вас и y добру и y злу.", 40);
		...
		if (scenePhase == 12) {
			drawBlackBackground(1.0F);
			gp.getClass();
			drawString(1.0F, 38.0F, 576 / 2, "Хвала опет свима, што сте дошли.\nЧекајте мало, има још ..... ;)\nМало стрпљења молим ^_^ ", 40);
